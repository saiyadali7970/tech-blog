            ...
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-gray-700/20">
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Message Sent!</h3>
              ...
              <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-8 border border-white/20 dark:border-gray-700/20">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 mb-2">Get in touch via email</p>
                    <a href="mailto:hello@techblog.com" className="text-blue-600 dark:text-blue-400 font-semibold hover:underline">
                      hello@techblog.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-3">
                      ...
                      <a href="#" className="w-10 h-10 bg-gray-900 rounded-lg flex items-center justify-center text-white hover:bg-gray-800 transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
