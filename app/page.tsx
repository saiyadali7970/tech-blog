...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <section
        id="hero-section"
        className="relative overflow-hidden animated-gradient py-24 md:py-32 lg:py-40"
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div
            className="absolute top-40 right-16 w-32 h-32 bg-yellow-400/30 rounded-full blur-2xl animate-float"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-20 left-1/4 w-16 h-16 bg-pink-400/40 rounded-full blur-xl animate-float"
            style={{ animationDelay: "4s" }}
          ></div>
          <div
            className="absolute top-1/2 right-1/4 w-24 h-24 bg-blue-400/20 rounded-full blur-2xl animate-float"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-40 right-20 w-12 h-12 bg-purple-400/30 rounded-full blur-xl animate-float"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center slide-up">
            ...
            <p
              id="hero-description"
              className="text-xl md:text-2xl lg:text-3xl text-blue-100 mb-12 max-w-4xl mx-auto font-medium leading-relaxed"
            >
              Discover cutting-edge insights in web development, programming,
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            id="stats-container"
            className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20"
          >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Everything you need to stay ahead in the rapidly evolving world of
              technology
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Stay updated with cutting-edge frameworks, tools, and best practices in web development.",
              },
              {
                icon: "👨‍💻",
              ...
              },
              {
                ...
                description:
                  "Step-by-step tutorials that take you from beginner to expert level.",
              },
              {
                icon: "🎯",
                title: "Practical Examples",
                description:
                  "Real code examples and projects you can implement immediately.",
              },
              {
                icon: "🔄",
                title: "Regular Updates",
                description:
                  "Fresh content published weekly to keep your skills sharp.",
              },
              {
                icon: "🌟",
                title: "Community Driven",
                description:
                  "Join a community of passionate developers sharing knowledge.",
              },
            ].map((feature, index) => (
              <div
                key={index}
      ...
      <section
        ...
        data-testid="testimonials-showcase"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2
            ...
            {[
              {
                ...
                avatar: "AR",
                quote:
                  "TechBlog has been instrumental in keeping me updated with the latest React patterns. The quality of content is exceptional!",
              },
              {
                name: "Sarah Kim",
                ...
                avatar: "SK",
                quote:
                  "The step-by-step tutorials helped me transition from junior to senior developer. Highly recommend to anyone serious about coding.",
              },
              {
                name: "Marcus Johnson",
                ...
                avatar: "MJ",
                quote:
                  "Best resource for staying current with modern development practices. The authors really know what they're talking about.",
              },
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Stay ahead of the curve with our handpicked selection of the most
              relevant and insightful articles
            </p>
          </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div
            ...
            className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-500 rounded-3xl p-12 text-center text-white"
          >
            <h3
              id="newsletter-title"
            ...
            >
              Join 50,000+ developers getting the latest insights delivered to
            ...
            <p id="newsletter-disclaimer" className="text-sm mt-4 opacity-75">
