    ...
    <div className="bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen flex items-center justify-center">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-3xl p-12 shadow-2xl border border-white/20 dark:border-gray-700/20">
          {/* 404 Animation */}
          <div className="mb-8">
            <div className="text-8xl font-black text-gradient mb-4 animate-bounce">404</div>
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
            ...
            Don't worry though, even the best developers hit a 404 sometimes.
          </p>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-8">
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Or try one of these popular sections:</p>
            <div className="flex flex-wrap justify-center gap-3">
              <Link href="/about" className="text-sm text-blue-600 dark:text-blue-400 hover:underline">About</Link>
              <span className="text-gray-300 dark:text-gray-600">•</span>
              <Link href="/contact" className="text-sm text-blue-600 dark:text-blue-400 hover:underline">Contact</Link>
              <span className="text-gray-300 dark:text-gray-600">•</span>
              <Link href="/blog/getting-started-nextjs-14" className="text-sm text-blue-600 dark:text-blue-400 hover:underline">Latest Post</Link>
            </div>
          </div>
        </div>
      </div>
